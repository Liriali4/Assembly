# Caregar de 1 á 150 e exibir de 120 á 1 os dobros dos impares
.data
vector: .space 600
n:      .asciiz "\n"
info:   .asciiz "\nDecrescentes de 120 á 1 os dobros dos impares\n"
final:  .asciiz "\n\n Fim do programa!!!\n\n"
...
Fim_if:
    addi $t1, $t1, -4
    slti $t2, $t1, 0        # $t2 = 1 se $t1 < 0
    beq $t2, $zero, Encontrar_impares  # se $t1 >= 0, continua
